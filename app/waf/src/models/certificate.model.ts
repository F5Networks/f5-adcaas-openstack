...
export class Certificate extends CommonEntity {
  ...
  getAS3Declaration(): AS3Declaration {
    ...
    let certPath: BIGIPPath = {};
    let keyPath: BIGIPPath = {};

    certPath.bigip = this.certificate;
    obj.certificate = certPath;

    keyPath.bigip = this.privateKey;
    obj.privateKey = keyPath;
