...
export class ProfileHTTPCompressionRepository extends CommonRepository<
  ProfileHTTPCompression,
  typeof ProfileHTTPCompression.prototype.id
> {
  constructor(
    ...
    super(ProfileHTTPCompression, dataSource, reqCxt);
  }
}
