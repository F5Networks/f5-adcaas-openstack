...
class OverviewTab(tabs.Tab):
    name = _("Overview")
    slug = "overview"
    template_name = ("f5services/f5adc/"
...
class LogTab(tabs.Tab):
    name = _("Log")
    slug = "log"
    template_name = "f5services/f5adc/_detail_log.html"
    preload = False
...
class ConsoleTab(tabs.Tab):
    name = _("Console")
    slug = "console"
    template_name = "f5services/f5adc/_detail_console.html"
    preload = False
...
class AuditTab(tabs.TableTab):
    ...
    template_name = "f5services/f5adc/_detail_audit.html"
    preload = False
