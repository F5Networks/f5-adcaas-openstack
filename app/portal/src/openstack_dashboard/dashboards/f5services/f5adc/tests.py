...
from openstack_dashboard.dashboards.f5services.f5adc import console
from openstack_dashboard.dashboards.f5services.f5adc import tables
from openstack_dashboard.dashboards.f5services.f5adc import tabs
from openstack_dashboard.dashboards.f5services.f5adc import workflows
...
INDEX_URL = reverse('horizon:f5services:f5adc:index')
...
class InstanceTests(helpers.ResetImageAPIVersionMixin, helpers.TestCase):
    ...
    def test_suspend_instance(self):
        ...
        url = get_url_with_pagination(
            self.request, 'next', 'prev', 'horizon:f5services:f5adc:index')
    ...
    def test_suspend_instance_if_placed_on_2nd_page(self):
        ...
        url = "?".join([reverse('horizon:f5services:f5adc:index'),
                        params])
    ...
    def _get_instance_details(self, server, qs=None,
        ...
        url = reverse('horizon:f5services:f5adc:detail', args=[server.id])
        if qs:
            url += qs
    ...
    def test_instance_details_console_tab(self):
        ...
        self.assertTemplateUsed(res,
                                'f5services/f5adc/_detail_console.html')
    ...
    def test_instance_details_exception(self):
        ...
        url = reverse('horizon:f5services:f5adc:detail',
                      args=[server.id])
    ...
    def test_instance_details_flavor_not_found(self):
        ...
        self.assertTemplateUsed(res,
                                'f5services/f5adc/_detail_overview.html')
    ...
    def test_instance_log(self):
        ...
        url = reverse('horizon:f5services:f5adc:console',
                      args=[server.id])
        tg = tabs.InstanceDetailTabs(self.request, instance=server)
    ...
    def test_instance_auto_console(self):
        ...
        url = reverse('horizon:f5services:f5adc:auto_console',
                      args=[server.id])
        res = self.client.get(url)
    ...
    def test_instance_vnc_error(self):
        ...
        url = reverse('horizon:f5services:f5adc:vnc',
                      args=[server.id])
        res = self.client.get(url)
    ...
    def test_instance_spice(self):
        ...
        url = reverse('horizon:f5services:f5adc:spice',
                      args=[server.id])
        res = self.client.get(url)
        redirect = CONSOLE_URL
        self.assertRedirectsNoFollow(res, redirect)
    ...
    def test_instance_rdp(self):
        ...
        url = reverse('horizon:f5services:f5adc:rdp',
                      args=[server.id])
        res = self.client.get(url)
        redirect = CONSOLE_URL
        self.assertRedirectsNoFollow(res, redirect)
    ...
    def _test_instances_index_retrieve_password_action(self):
        ...
        self.mox.ReplayAll()
        url = reverse('horizon:f5services:f5adc:index')
        res = self.client.get(url)
    ...
    def test_decrypt_instance_password(self):
        ...
        self.mox.ReplayAll()
        url = reverse('horizon:f5services:f5adc:decryptpassword',
                      args=[server.id,
                            server.key_name])
        res = self.client.get(url)
        self.assertTemplateUsed(res, 'f5services/f5adc/decryptpassword.html')
    ...
    def test_instance_update_get(self):
        ...
        url = reverse('horizon:f5services:f5adc:update', args=[server.id])
        res = self.client.get(url)
    ...
    def test_instance_update_get_server_get_exception(self):
        ...
        url = reverse('horizon:f5services:f5adc:update',
                      args=[server.id])
        res = self.client.get(url)
    ...
    def test_launch_instance_get(self,
        ...
        url = reverse('horizon:f5services:f5adc:launch')
    ...
    def test_instance_resize_get(self):
        ...
        url = reverse('horizon:f5services:f5adc:resize', args=[server.id])
        res = self.client.get(url)
    ...
    def test_instance_resize_get_server_get_exception(self):
        ...
        url = reverse('horizon:f5services:f5adc:resize',
                      args=[server.id])
        res = self.client.get(url)
    ...
    def test_rebuild_instance_get(self, expect_password_fields=True):
        ...
        url = reverse('horizon:f5services:f5adc:rebuild', args=[server.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'f5services/f5adc/rebuild.html')
    ...
    def _instance_rebuild_post(self, server_id, image_id,
        ...
        url = reverse('horizon:f5services:f5adc:rebuild',
                      args=[server_id])
    ...
    def test_index_form_action_with_pagination(self):
        ...
        params = "=".join([tables.InstancesTable._meta.pagination_param,
                           servers[page_size - 1].id])
        next_page_url = "?".join([reverse('horizon:f5services:f5adc:index'),
                                  params])
...
class ConsoleManagerTests(helpers.ResetImageAPIVersionMixin, helpers.TestCase):
    ...
    def test_interface_attach_get(self):
        ...
        url = reverse('horizon:f5services:f5adc:attach_interface',
                      args=[server.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res,
                                'f5services/f5adc/attach_interface.html')
    ...
    def test_volume_attach_get(self):
        ...
        url = reverse('horizon:f5services:f5adc:attach_volume',
                      args=[server.id])
        ...
        self.assertTemplateUsed(res,
                                'f5services/f5adc/attach_volume.html')
    ...
    def test_volume_detach_get(self):
        ...
        url = reverse('horizon:f5services:f5adc:detach_volume',
                      args=[server.id])
        ...
        self.assertEqual(res.status_code, 200)
        self.assertTemplateUsed(res,
                                'f5services/f5adc/detach_volume.html')
    ...
    def test_interface_detach_get(self):
        ...
        url = reverse('horizon:f5services:f5adc:detach_interface',
                      args=[server.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res,
                                'f5services/f5adc/detach_interface.html')
