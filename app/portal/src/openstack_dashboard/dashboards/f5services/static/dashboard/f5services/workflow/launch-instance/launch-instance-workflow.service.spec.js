...
(function() {
  ...
  describe('horizon.dashboard.f5services.workflow.launch-instance.workflow tests', function () {
    ...
    beforeEach(inject(function ($injector) {
      launchInstanceWorkflow = $injector.get(
        'horizon.dashboard.f5services.workflow.launch-instance.workflow'
      );
      stepPolicy = $injector.get('horizon.dashboard.f5services.workflow.launch-instance.step-policy');
    }));
