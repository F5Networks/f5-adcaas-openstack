  ...
  describe('Launch Instance Source Step', function() {
    ...
    describe('LaunchInstanceSourceController', function() {
      ...
      beforeEach(module(function($provide, $injector) {
        ...
        $provide.value(
          'horizon.dashboard.f5services.workflow.launch-instance.boot-source-types', noop
        );
        ...
        $provide.value('horizon.dashboard.f5services.workflow.launch-instance.basePath', '');
      }));
