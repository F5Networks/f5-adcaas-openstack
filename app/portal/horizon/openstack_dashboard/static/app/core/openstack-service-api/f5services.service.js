...
(function () {
    ...
    angular
      ...
      .factory('horizon.app.core.openstack-service-api.f5services', f5ServicesAPI);
  
      f5ServicesAPI.$inject = [
     ...
     */
    function f5ServicesAPI(apiService, toastService) {
      var service = {
        // query: query,
        createADC: createADC
      };
    ...
    //       });
    //   }
    function createADC(newServer) {
        return apiService.post('/api/f5services/adcs/', newServer)
          .error(function () {
