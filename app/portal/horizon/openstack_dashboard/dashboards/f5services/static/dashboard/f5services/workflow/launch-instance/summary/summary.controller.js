...
(function () {
  ...
  angular
    ...
    .controller('LaunchInstanceSummaryController', LaunchInstanceSummaryController);

    LaunchInstanceSummaryController.$inject = [
      '$scope',
      'launchInstanceModel'
    ];
  /**
   * @ngdoc controller
   * @name LaunchInstanceSummaryController
   * @description
   * The `LaunchInstanceSummaryController` controller is responsible for
   ...
   */
  function LaunchInstanceSummaryController($scope, launchInstanceModel) {
    var ctrl = this;
    ...
    ctrl.initSummaryHTML = initSummaryHTML;

    function initSummaryHTML() {
      var data = launchInstanceModel.setFinalSpecs();
