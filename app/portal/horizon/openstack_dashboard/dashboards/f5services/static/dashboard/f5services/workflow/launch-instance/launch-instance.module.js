...
(function () {
  ...
  angular
    ...
    .config(config)
    .constant('horizon.dashboard.f5services.workflow.launch-instance.modal-spec', {
      backdrop: 'static',
      size: 'lg',
    ...
    /**
     * @name horizon.dashboard.f5services.workflow.launch-instance.boot-source-types
     * @description Boot source types
     */
    .constant('horizon.dashboard.f5services.workflow.launch-instance.boot-source-types', {
      IMAGE: 'image',
    ...
    .constant('horizon.dashboard.f5services.workflow.launch-instance.non_bootable_image_types',
      ['aki', 'ari'])

    /**
     * @name horizon.dashboard.f5services.workflow.launch-instance.step-policy
     * @description Policies for displaying steps in the workflow.
     */
    .constant('horizon.dashboard.f5services.workflow.launch-instance.step-policy', {
  ...
  function config($provide, $windowProvider) {
    var path = $windowProvider.$get().STATIC_URL + 'dashboard/f5services/workflow/launch-instance/';
    $provide.constant('horizon.dashboard.f5services.workflow.launch-instance.basePath', path);
  }
