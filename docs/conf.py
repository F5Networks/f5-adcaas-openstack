...
project = u'F5 ADCaaS for OpenStack'
...
latex_documents = [
    (master_doc, 'F5 ADCaaS for OpenStack.tex',
     u'F5 F5 ADCaaS for OpenStack - Documentation',
     'F5 Networks', 'manual'),
]
...
man_pages = [
    (master_doc, 'F5 ADCaaS for OpenStack',
     'F5 ADCaaS for OpenStack - Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'F5 ADCaaS for OpenStack',
     'F5 ADCaaS for OpenStack - Documentation',
     author, 'F5 ADCaaS for OpenStack', 'manual'),
]
