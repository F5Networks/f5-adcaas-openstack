...
project = u'F5 OpenStack Services'
...
latex_documents = [
    (master_doc, 'F5 OpenStack Services.tex',
     u'F5 OpenStack Services - Documentation',
     'F5 Networks', 'manual'),
]
...
man_pages = [
    (master_doc, 'F5 OpenStack Services',
     'F5 OpenStack Services  - Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'F5 OpenStack Services',
     'F5 OpenStack Services - Documentation',
     author, 'F5 OpenStack Services', 'manual'),
]
